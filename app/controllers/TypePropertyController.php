...
class TypePropertyController extends ControllerBase
{
    ...
    public function indexAction()
    {
    	...
    	foreach ($typeProperties as $Stypeproperty){
    		$id = $Stypeproperty->getStype()->getId();
    		...
    		$table->addRow([$i+1,$Stypeproperty->getStype()->getName(),$label,$btnUpdate]);
    		$i++;
    	}
    ...
    public function vUpdateAction($idStype,$active = NULL){
    	...
    	foreach ($StypeProperties as $Stypeproperty){
    		...
    		$table->addRow(
    				[
    						$i+1,//col1
    						$Stypeproperty->getName()."(".$Stypeproperty->getProperty()->getName().")".$hiddenPrprty,//col2
    						$inputName,//Col3
    						$inputTemplate,//col4
    						$btnDelete
    				]);
